<x-panel-layout>
    ...
    <h1 class="panel-page-title" style="margin:8px 0 24px;">Edit Quiz</h1>

    <div class="panel-card" style="max-width:560px;">
        <div class="panel-card-body">
            <form method="POST" action="{{ route('mentor.quizzes.update', [$course, $quiz]) }}">
                @csrf @method('PUT')
                ...
                <div style="display:flex;gap:10px;margin-top:8px;">
                    <button type="submit" class="btn-register">Update Quiz</button>
